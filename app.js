...
const SPECIAL_TESTS = [
  { id: 1, name: "น้ำตาลในเลือด (FBS)", price: 30, fasting: true, category: "blood", icon: '<i class="fa-solid fa-droplet" style="color: #ef4444;"></i>', notes: "สิทธิประกันสังคมพนักงานอายุ 35 ปีขึ้นไปฟรี (กรณีไม่เคยใช้สิทธิ์ตรวจของประกันสังคมในปีนี้) | *งดอาหารและเครื่องดื่มล่วงหน้าอย่างน้อย 8-10 ชั่วโมง (ดื่มน้ำเปล่าได้)*" },
  { id: 2, name: "ตรวจหาระดับไขมันในเลือด (Cholesterol, Triglyceride, HDL, LDL)", price: 160, fasting: true, category: "blood", icon: '<i class="fa-solid fa-flask" style="color: #f59e0b;"></i>', notes: "งดอาหารและเครื่องดื่มล่วงหน้าอย่างน้อย 8-10 ชั่วโมง (ดื่มน้ำเปล่าได้) | ฟรี สำหรับพนักงานอายุ 35 ปีขึ้นไป (พนักงานอายุไม่ถึง 35 ปี ตรวจเฉพาะ Cholesterol, HDL ฟรี โดยต้องงดอาหารและเครื่องดื่ม)" },
